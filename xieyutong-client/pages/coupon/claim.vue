  ...
  <view class="min-h-screen bg-gray-50">
    ...
    <view v-else-if="couponInfo" class="p-4">
      ...
      <view class="space-y-3">
        ...
        <button 
          @click="goToMyCoupons"
          class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-4 rounded-lg font-medium transition-colors"
        >
          查看我的优惠券
        </button>
        ...
        <button 
          @click="goToHome"
          class="w-full border border-gray-300 hover:bg-gray-50 text-gray-700 py-4 rounded-lg font-medium transition-colors"
        >
          返回首页
        </button>
      </view>
    ...
    <view v-else class="flex flex-col items-center justify-center py-20 px-4">
      ...
      <button @click="goToHome" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg">
        返回首页
      </button>
    </view>
  </view>
