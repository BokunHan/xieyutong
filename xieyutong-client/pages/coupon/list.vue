    ...
    <view class="bg-white shadow-sm">
      <view class="flex items-center justify-between px-4 py-3">
        <view class="flex items-center space-x-3">
          <text 
            class="i-awesome fas fa-arrow-left text-gray-600 text-lg" 
            @click="goBack"
          ></text>
    ...
    <view class="p-4">
          ...
          <view class="flex">
            ...
            <view class="flex-1 p-4">
              <view class="flex items-start justify-between">
                ...
                <!-- 状态标签 -->
                <view v-if="coupon.status !== 'unused'" :class="[
                  'px-2 py-1 rounded text-xs',
                  coupon.status === 'used' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500'
                ]">
      ...
      <view v-if="hasMore && !loading" class="flex justify-center py-4">
        <button 
          ...
          class="bg-gray-100 hover:bg-gray-200 disabled:bg-gray-100 text-gray-600 px-6 py-2 rounded-lg text-sm"
        >
