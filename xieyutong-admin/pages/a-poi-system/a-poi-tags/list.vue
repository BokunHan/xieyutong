	...
	<view class="px-5 py-3">
		<view class="uni-header">
			<view class="uni-group">
				...
				<view class="uni-title ml-2">POI 标签管理</view>
			...
			<unicloud-db
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
					...
					<uni-tr v-for="(item, index) in data" :key="index">
						...
						<uni-td align="center">
							<view class="uni-group">
								<button @click="navigateTo('../a-poi-database/list?tag_id=' + item._id + '&tag_name=' + item.name, false)" class="uni-button" size="mini" type="primary">
									查看POIs
								</button>
...
<script>
import { enumConverter, filterToWhere } from '../../../js_sdk/validator/a-poi-tags.js';
