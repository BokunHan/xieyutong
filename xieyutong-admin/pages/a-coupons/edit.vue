  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,description,amount,min_amount,issue_type,total_count,used_count,valid_days,share_code,auto_issue_condition,status,created_at,updated_at").get().then((res) => {
