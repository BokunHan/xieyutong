<template>
	<view class="uni-container">
		<uni-forms ref="form" :value="formData" validateTrigger="bind">
			...
			<uni-forms-item name="permission_desc" label="权限描述">
				<textarea placeholder="权限描述" @input="binddata('permission_desc', $event.detail.value)" class="uni-textarea-border" v-model="formData.permission_desc" trim="both" />
			</uni-forms-item>
