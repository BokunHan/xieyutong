					...
					<view class="p-4 border-b border-gray-200">
						<view class="flex items-center justify-between">
							...
							<view class="text-sm text-gray-500">
								共找到 <text class="font-semibold text-blue-600 text-base">{{pagination.count}}</text> 个用户
							</view>
						</view>
					</view>
									...
									>
										...
										<td class="px-4 py-4">
											<view class="flex flex-wrap gap-1">
												<span v-for="(role, roleIndex) in getRoleArray(item.role)" :key="roleIndex" 
