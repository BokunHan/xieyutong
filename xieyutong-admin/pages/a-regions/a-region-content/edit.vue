	...
	<view class="uni-container">
		<view class="uni-header">
			<view class="uni-group">
				...
				<view class="uni-title ml-2">编辑区域提示</view>
		...
		<uni-forms class="mt-3" ref="form" :model="formData" validateTrigger="bind">
			...
			<uni-forms-item name="content" label="详细内容">
				<view class="wangeditor-container">
					<sv-wangeditor v-model:html="formData.content" :toolbarConfig="toolbarConfig" :editorConfig="editorConfig" mode="default" @change="onEditorChange"></sv-wangeditor>
				</view>
			</uni-forms-item>
	...
	methods: {
		...
		getDetail(id) {
			...
			db.collection(dbCollectionName)
				.doc(id)
				.field('region_id,type,title,content,order,status')
				.get()
				.then((res) => {
