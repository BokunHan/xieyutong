  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("config_key,config_value,config_type,description,status,version,effective_date,created_by,updated_by,created_at,updated_at").get().then((res) => {
