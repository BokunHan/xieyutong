  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,level,total_consumption,order_count,upgrade_threshold,benefits,status,join_date,upgrade_date,expire_date,created_at,updated_at").get().then((res) => {
