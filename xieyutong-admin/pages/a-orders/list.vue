          ...
          <view class="p-4 border-b border-gray-200">
            <view class="flex items-center justify-between">
              ...
              <view class="text-sm text-gray-500">
                共找到 <text class="font-semibold text-emerald-600 text-base">{{pagination.count}}</text> 个订单
              </view>
            </view>
          </view>
              ...
              <table class="w-full" style="min-width: 1400px;">
                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th class="px-4 py-4 text-left text-sm font-semibold text-gray-900 w-80">
                      商品信息
                    </th>
                    ...
                    <th class="px-4 py-4 text-center text-sm font-semibold text-gray-900 w-40">
                      操作
                    </th>
                  </tr>
                </thead>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  >
                    ...
                    <td class="px-4 py-4">
                      <view class="flex items-center">
                        <text class="text-sm font-mono text-emerald-700 bg-emerald-50 px-2 py-1 rounded cursor-pointer hover:bg-emerald-100 transition-colors" @click="copyToClipboard(item.order_no)">
                          {{item.order_no || '-'}}
                        </text>
                    ...
                    <td class="px-4 py-4">
                      <view class="flex items-center">
                        ...
                        <text class="text-sm text-orange-600 font-medium">
                          {{item.duration_days || 0}}天
                        </text>
                      </view>
                    </td>
